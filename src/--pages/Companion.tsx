...
export default function Companion() {
  ...
  useEffect(() => {
    ...
    const contextType = searchParams?.contextType as ChatContext["type"] | null;
    ...
    const contextDataParam = searchParams?.contextData || undefined;
  ...
  useEffect(() => {
    ...
    if (conversationIdParam) {
      ...
      navigate(`/companion/${newId}`, { replace: true });
    }
  }, [
    conversationIdParam,
    conversationId,
